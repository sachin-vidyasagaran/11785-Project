...
Experience = namedtuple('Experience', 'state0, action, reward, state1, terminal1,goal')
...
class Memory(object):
    ...
    def append(self, observation, action, reward, terminal,goal, training=True):
...
class SequentialMemory(Memory):
    ...
    def sample(self, batch_size, batch_idxs=None):
        ...
        for idx in batch_idxs:
            ...
            experiences.append(Experience(state0=state0, action=action, reward=reward,
                                          state1=state1,goal=goal,terminal1=terminal1))
    ...
    def append(self, observation, action, reward, terminal,goal, training=True):
        super(SequentialMemory, self).append(observation, action, reward, terminal,goal, training=training)
