...
class DDPGagentwithHER:
    def __init__(self, env, hidden_sizes, actor_learning_rate=1e-4, critic_learning_rate=1e-3, gamma=0.99, tau=1e-2,
        ...
        self.num_goals = env.observation_space.shape[0]
        self.gamma = gamma
        self.tau = tau
        ...
        self.critic = Critic(self.num_states, self.num_actions, self.num_goals, hidden_sizes)
        self.critic_target = Critic(self.num_states, self.num_actions, self.num_goals, hidden_sizes)
